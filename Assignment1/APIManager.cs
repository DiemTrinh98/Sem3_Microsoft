...
namespace Assignment1
{
    class APIManager
    {
        public static async Task<List<RootObject>> GetData()
        {
            ...
            var url = String.Format("http://tommyprivateguide.com/wp-json/wp/v2/posts?param%2Fdata.json&fbclid=IwAR0IFxBcRHYkmHhXZF1S5SHN-WVOU8NhR6gYlZKvF8nJTRtWBATGspdms4M");
